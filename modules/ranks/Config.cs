...
public sealed partial class Plugin : BasePlugin
{
    ...
    private void RegisterConfigs()
    {
        ...
        _moduleServices.RegisterModuleConfig("Settings", "DynamicDeathPointsMaxMultiplier", "Maximum multiplier for dynamic death points", 6.0);
        _moduleServices.RegisterModuleConfig("Settings", "DynamicDeathPointsMinMultiplier", "Minimum multiplier for dynamic death points", 3.0);
        ...
        _moduleServices.RegisterModuleConfig("Points", "Headshot", "Bonus points for headshot", 15);
        ...
        _moduleServices.RegisterModuleConfig("Points", "AssistFlash", "Points for flash assist", 6);
        ...
        _moduleServices.RegisterModuleConfig("Points", "MVP", "Points for MVP", 30);
        ...
        _moduleServices.RegisterModuleConfig("Points", "BombDefused", "Points for defusing the bomb", 20);
        _moduleServices.RegisterModuleConfig("Points", "BombDefusedOthers", "Points for teammates when bomb is defused", 7);
        _moduleServices.RegisterModuleConfig("Points", "BombPlant", "Points for planting the bomb", 10);
        _moduleServices.RegisterModuleConfig("Points", "BombExploded", "Points for bomb explosion", 15);
        ...
        _moduleServices.RegisterModuleConfig("Points", "DoubleKill", "Points for double kill", 20);
        ...
        _moduleServices.RegisterModuleConfig("Points", "InfernoKill", "Points for fire kill (Molotov/Incendiary)", 15);
